                                ...
                                <div class="card-body">
                                    <form action="Controller/productcontroller.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <label class="col-md-3">Image</label>
                                            <input type="file" name="image" class="col-md-8 input--style-5">
                                        </div>

                                        <div class="form-group form-row">
                                        <label class="col-md-3">Price</label>
                                            <input type="text" name="price" autocomplete="off" pattern="^\d{1,}$" title="numeric characters only" required placeholder="Price..." class="col-md-8 input--style-5">
                                        </div>
                                        ...
                                        <label class="col-md-3">Discription</label>
                                            ...
                                            <textarea name="description" required placeholder="description..." class="col-md-8 input--style-5"></textarea>
                                        </div>
