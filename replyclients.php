...
<body>
   ...
   <center><h1>Reply to clients</h1></center>
    <tr>
    <th>user id</th>
    <th>user name</th>
    <th>Date</th>
   ...
   <?php
     $stmt = $admin->ret("SELECT * FROM `contact` ORDER BY `con_id` DESC ");
...
<tr>
    ...
    <td><a href="Controller/contactdelete.php?con_id=<?php echo $row['con_id']; ?>" OnClick="return confirm('are you sure')">delete</a></td>
     <td><a href="replyadmin.php?con_id=<?php echo $row['con_id']; ?>">reply</a></td>
   <!--  <td><a href="contactdelete.php?con_id=<?php echo $row['con_id']; ?>" OnClick="return confirm('are you sure')">reply</a></td> -->
