...
<!-- <input type="text" name="search" class="form-control" placeholder="Enter Name for search" onkeyup="searchit(this.value)"> -->
   ...
   <?php
     $stmt = $admin->ret("SELECT * FROM `payment` ORDER BY `payment_id` DESC ");
...
<tr>
    ...
    <td><a href="Controller/paymentdelete.php?payment_id=<?php echo $row['payment_id']; ?>" OnClick="return confirm('are you sure')">delete</a></td>
