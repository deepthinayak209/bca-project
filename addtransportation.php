                        ...
                        <div class="wrapper wrapper--w790">
                            <div class="card card-5">
                                <div class="card-heading">
                                    <h2 class="title">TRANSPORTATION DETAILS</h2>
                                </div>
                                <div class="card-body">
                                    <form action="Controller/transportationcontroller.php" method="POST">
                
                                        <div class="form-group form-row">
                                        <label class="col-md-3">Vehical Name</label>
                                            <input type="text" name="name" pattern="[A-Za-z]+" title="letters only" required placeholder="Type of transport..." class="col-md-8 input--style-5">
                                        </div>

                                        <div class="form-group form-row">
                                        <label class="col-md-3">Vehical Number</label>
                                            <input type="text" name="vehical_no" required placeholder="Vehical Number..." class="col-md-8 input--style-5">
                                        </div>

                                        <div class="form-group form-row">
                                        <label class="col-md-3">Destination</label>
                                            <input type="text" name="destination" required placeholder="Destination..." class="col-md-8 input--style-5">
                                        </div>

                                        <div class="form-group form-row">
                                        <label class="col-md-3">Description</label>
                                            <input type="text" name="description" required placeholder="Description..." class="col-md-8 input--style-5">
                                        </div>
