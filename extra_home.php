...
<head>
    ...
    <!-- Favicon
    ================================================== -->
    <!-- <link rel="apple-touch-icon" sizes="180x180" href="index/img/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="16x16" href="images/logo-copy.jpg"> -->
...
<body>
    ...
    <header id="masthead" class="site-header" data-anchor-target=".hero" data-top="background: rgba(59,58,54,0); border-bottom-color: rgba(226,226,226,0);" data-top-bottom="background: rgba(59,58,54,1); border-bottom-color: rgba(226,226,226,1);">
        ...
        <?php include "header.php";?><!-- /.site-navigation -->
    ...
    <div class="hero background-overlay">
        ...
        <div class="hero-text">
            ...
            <br>
            <br>
            <div class="site-title yellow-text">
            <center><h2><i><?php echo $_SESSION['user'];?></i></h2></center>
            </div>
        </div> <!-- /.hero-text -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-xs-6">
                    ...
                    <div class="mb-xs-20">
                        <a href="home.php" class="site-title yellow-text">Sovereign<span>Tile</span></a>
                ...
                <div class="col-md-3 col-xs-6">
                    ...
                    <div class="mb-xs-20">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="cproducts.php">Products</a></li>
