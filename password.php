...
<body>
  ...
  <div class="container-contact100" style="background-image: url('images/bg3.jpg');">
    ...
    <div class="wrap-contact100">
      <form class="contact100-form validate-form" action="Controller/passwordcontroller.php" method="POST">
      <!-- <form method="POST"> -->
        ...
        <div class="wrap-input100 validate-input">
          <input class="input100" type="hidden" name="user_id" value="<?php echo $_SESSION['id'];?>">
           <input class="input100" type="text" name="user_name" value="<?php echo $_SESSION['user'];?>" readonly>
          <!-- <span class="focus-input100"><?php echo $_SESSION['user'];?></span> -->
        </div>
        ...
        <div class="wrap-input100 validate-input">
          <input class="input100" type="text" name="question" value="<?php echo $row['question'];?>" readonly>
          <span class="focus-input100"></span>
        </div>

        <!-- <div class="wrap-input100 validate-input" data-validate = "Please enter your answer">
          <textarea class="input100" name="answer" placeholder="Answer..."></textarea>
          <span class="focus-input100"></span>
        </div> -->
        ...
        <div class="container-contact100-form-btn">
          <div class="contact100-form-btn">
              <input type="submit" name="submit" value="done" class="contact100-form-btn">                                       
          </div>
        </div>
      </form>
    </div>
