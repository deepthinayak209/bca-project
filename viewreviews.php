...
<td><?php echo $row['user_id']; ?></td>
    ...
    <td><a href="Controller/reviewdelete.php?review_id=<?php echo $row['review_id']; ?>" OnClick="return confirm('are you sure')">delete</a></td>
    <!-- <td><a href="updateclient.php?client_id=<?php echo $row['client_id']; ?>" OnClick="return confirm('are you sure')">update</a></td> -->
</tr>
<?php } ?>
</table>
